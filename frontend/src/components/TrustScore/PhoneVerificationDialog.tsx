...
export const PhoneVerificationDialog: React.FC<PhoneVerificationDialogProps> = ({ open, onClose }) => {
  const { requestPhoneVerification, confirmPhoneVerification } = useTrustScore();
  ...
  return (
    <div className="phone-verification-dialog">
      <div className="dialog-content">
        <h3>Verificação de Telefone</h3>
        {step === 'request' && (
          <>
            <p>Para verificar seu telefone, clique abaixo para receber um código por SMS.</p>
